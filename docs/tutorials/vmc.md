...
The objective is the Rayleigh quotient
$\langle\psi\vert h \vert\psi\rangle/\langle\psi\vert\psi\rangle$, built from a left-to-right
chain of **pairwise** `tenet.einsum` calls. Three or more operands would bring in a contraction
